...
The dominant bottleneck is usually the base system: context, memory, deployment, observability, orchestration, and interfaces, not any single model or UI feature.
