...
Use AI as a collaborator inside a verified engineering loop. Define success, expose runtime feedback, and let the agent iterate against observable results.
