# Multi-Agent Analysis Best Practices
...
Split analytical work only when scopes are independent, responsibilities are clear, and integration has an explicit synthesis step.
