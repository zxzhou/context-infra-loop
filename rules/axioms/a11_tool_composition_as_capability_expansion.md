# A11. Tool Composition Expands Capability

## 1. Core Axiom

New capability often comes from composing existing tools with shared state and clear interfaces, not from inventing a single larger tool.
