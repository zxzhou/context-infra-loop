# A03. From IC to Manager

## 1. Core Axiom

Using AI well resembles managing capable contributors: set context, define success, inspect outputs, and build feedback loops instead of micromanaging implementation.
