...
For AI-assisted work, specify the desired outcome and verification bar more strongly than the exact path. Let the system choose implementation details when risk is bounded.
