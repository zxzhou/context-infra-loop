# V04. Temporal Grounding Prevents Hallucination

## 1. Core Axiom

Time-sensitive claims need dates, source freshness, and explicit uncertainty. Temporal grounding prevents stale facts from masquerading as current truth.
